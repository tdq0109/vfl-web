...
/* Mở ca: đếm tiền có sẵn trong két rồi ghi lại. Con số này là gốc của phép đối
   soát cuối ca — nhập sai ở đây thì cuối ca lệch đúng bằng ngần ấy.

   GIỜ MỞ CA LÀ GIỜ THẬT lúc bấm nút, do server đóng dấu — màn không gửi giờ
   lên, và cũng không có ô nào để sửa.

   ⚠ Tới muộn VẪN CHO MỞ, chỉ cảnh báo và ghi lại. Chặn không cho mở là đẩy lễ
   tân vào chỗ bán chui không có ca: tiền vào túi, không phiếu, không dấu vết. */
interface Props {
  locationName: string;
  /** Ca hiện tại theo khung chuẩn, và mở muộn bao nhiêu phút TÍNH TỚI LÚC NÀY.
      Bỏ trống nghĩa là giờ này không thuộc khung ca nào. */
